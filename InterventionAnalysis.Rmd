...
Intervention analyses workflow optimised using dynamic time warping and Bayesian structural time series models. Combines CausalImpact package written by Kay Brodersen at Google and the dtw package available in CRAN. In addition, we will introduce an R package called MarketMatching. Source: http://multithreaded.stitchfix.com/blog/2016/01/13/market-watch/ 
